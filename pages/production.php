...
<?php include __DIR__ . '/../includes/page-title.php'; ?>
    ...
    <nav class="p-production-nav">
      <ul class="p-production-nav__list">
        <li class="p-production-nav__item">
          <a class="p-production-nav__btn" href="#flow">衣装ができるまで</a>
        </li>
        <li class="p-production-nav__item">
          <a class="p-production-nav__btn" href="#technic">技法・素材</a>
        </li>
      </ul>
    </nav>

    <!-- section2: 衣装ができるまで（上部＝タイトル＋リード文） -->
    <section class="p-production-lead" id="flow">
      <div class="p-production-lead__inner">
        <h2 class="p-production-lead__title">衣装ができるまで</h2>
        <p class="p-production-lead__lead">
          皆様にお届けする大切なお衣装の数々。<br>
          華結びで扱うお衣装は日本で長い時間をかけて培われてきた技術の結晶です。<br>
          皆様の晴れの日を飾るお衣装がどのように作られるのか、<br>
          ここではそんな呉服の製作現場を一部、ご紹介致します。
        </p>
      </div>
    </section>

    <!-- 工程ブロック（図案ほか・計8個。同型を複製して番号/タイトル/本文/画像を差し替える） -->
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">1</span>
        <h3 class="p-production-step__title">図案</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">2</span>
        <h3 class="p-production-step__title">手描き友禅</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">3</span>
        <h3 class="p-production-step__title">引染</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">4</span>
        <h3 class="p-production-step__title">金彩加工</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">5</span>
        <h3 class="p-production-step__title">糸染め</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">6</span>
        <h3 class="p-production-step__title">西陣織</h3>
      </div>
    ...
    <div class="p-production-step">
      <div class="p-production-step__head">
        <span class="p-production-step__num">7</span>
        <h3 class="p-production-step__title">刺繍</h3>
      </div>
    ...
    <!-- section3: 技法・素材（上部＝タイトル＋リード文。見出しは section2 と共通 p-production-lead） -->
    <section class="p-production-lead" id="technic">
      <div class="p-production-lead__inner">
        <h2 class="p-production-lead__title">技法・素材</h2>
        <p class="p-production-lead__lead">
          婚礼衣装には様々な技法や素材が使われています。<br>
          長年修業を積んだ職人による技を詰め込んだ芸術品とも言える婚礼衣装。<br>
          また、素材にもこだわった打掛の魅力をご紹介いたします。
        </p>
      </div>
    </section>

    <!-- 技法・素材の中身: 2カラム×6行（全12件） -->
