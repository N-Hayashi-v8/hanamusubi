...
<body>
  <div class="p-mv">
    <div class="l-info">
      <p class="l-info__text">打掛のレンタルなら京都の華結び。結婚式を彩る最高級の色打掛をレンタルでご提供します。</p>
    </div>
...
<?php include __DIR__ . '/includes/header.php'; ?>
    ...
    <div class="p-price">
      ...
      <p class="p-price__lead">花嫁さま応援プライス(税込)</p>
      <p class="p-price__main">88,000円〜</p>
      <div class="p-price__cols">
        <div class="p-price__col">
          <p class="p-price__col-label">SPECIAL PRICE</p>
          <p class="p-price__col-value">税込 88,000円</p>
        </div>
        <div class="p-price__col">
          <p class="p-price__col-label">50% PRICE OFF</p>
          <p class="p-price__col-value">税込 110,000円</p>
        </div>
      </div>
    </div>
...
<?php include __DIR__ . '/includes/sidebar.php'; ?>
  ...
  <section class="p-rental">
    <div class="p-rental__inner">
        ...
        <li class="p-rental__band">
          <a class="p-rental__band-inner" href="#">
            ...
            <div class="p-rental__card">
              ...
              <p class="p-rental__more">一覧を見る</p>
            </div>
          </a>
        </li>
  ...
  <section class="p-belief">
    <div class="p-belief__head">
      <h2 class="p-belief__title">華結びのこだわり</h2>
      <p class="p-belief__en">BELIEF</p>
    </div>

    <ul class="p-belief__list">
    ...
    <div class="p-belief__more">
      <a class="p-belief__more-btn" href="#">華結びのこだわりを見る</a>
    </div>
  </section>
          ...
          <li class="p-report__item">
            <a class="p-report__card" href="#">
              ...
              <div class="p-report__body">
                ...
                <p class="p-report__detail">【神社結婚式】上賀茂神社</p>
              </div>
            </a>
          </li>
          <li class="p-report__item">
            <a class="p-report__card" href="#">
              ...
              <div class="p-report__body">
                ...
                <p class="p-report__detail">【京都前撮り】岡崎〜祇園</p>
              </div>
            </a>
          </li>
          <li class="p-report__item">
          ...
          <li class="p-report__item">
            <a class="p-report__card" href="#">
              ...
              <div class="p-report__body">
                ...
                <p class="p-report__plan">和婚プラン</p>
                <p class="p-report__detail">大原野神社で結婚式</p>
              </div>
            </a>
          </li>
          <li class="p-report__item">
            <a class="p-report__card" href="#">
              ...
              <div class="p-report__body">
                ...
                <p class="p-report__plan">京都前撮りプラン</p>
                <p class="p-report__detail">相良刺繍の白無垢</p>
              </div>
            </a>
          </li>
        </ul>
  ...
  <section class="p-blog">
    <div class="p-blog__inner">
      <!-- 左: ブログ記事リスト -->
      <div class="p-blog__col p-blog__col--blog">
        <div class="p-blog__head">
          <h2 class="p-blog__title">花結びブログ</h2>
          <a class="p-blog__index" href="#">一覧を見る</a>
        </div>
        <ul class="p-blog__list">
          <li class="p-blog__item">
            <a class="p-blog__link" href="#">
              <p class="p-blog__meta">2024.04.24 | 婚礼衣装について</p>
              <h3 class="p-blog__post-title">色打掛 薄紫牡丹</h3>
            </a>
          </li>
          <li class="p-blog__item">
            <a class="p-blog__link" href="#">
              <p class="p-blog__meta">2024.04.24 | 京都神社結婚式</p>
              <h3 class="p-blog__post-title">【色打掛】黒地 四季詰御所車 /【色打掛】赤菖…</h3>
            </a>
          </li>
          <li class="p-blog__item">
            <a class="p-blog__link" href="#">
              <p class="p-blog__meta">2024.04.24 | 京都神社結婚式</p>
              <h3 class="p-blog__post-title">【白無垢】相良四季草花鳳凰</h3>
            </a>
          </li>
        </ul>
      </div>
      ...
      <!-- 右: Facebook -->
      <div class="p-blog__col p-blog__col--fb">
        <div class="p-blog__head">
          <h2 class="p-blog__title">Facebook</h2>
        </div>
        <div class="p-blog__fb">
          <p class="p-blog__fb-text">ここにFacebookからの<br>リンクを貼る</p>
        </div>
      </div>
    </div>
  </section>
